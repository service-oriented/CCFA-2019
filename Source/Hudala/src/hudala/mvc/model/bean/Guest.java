...
public class Guest extends User {
	...
	public String toString() {
		return "Guest [guestId=" + guestId + ", weight=" + weight + ", height=" + height + ", body=" + body
				...
				+ ", faceShape=" + faceShape + ", favorite=" + favorite + ", accountId=" + accountId + ", account="
				+ account + ", fullName=" + fullName + ", birth=" + birth + ", image=" + image + ", gender=" + gender
				+ ", phone=" + phone + ", email=" + email + ", job=" + job + ", link=" + link + "]";
	}
